# coding: utf-8
# Script for performing GMM inference formulated on the product manifold with the sythetic data received from another network
#
# Reference: 
...
plt.tight_layout()
plt.grid(True)
plt.savefig("figures/ALL_gmm_uniform.pdf", bbox_inches='tight')
plt.show()
