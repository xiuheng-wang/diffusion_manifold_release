# coding: utf-8
# Script for performing PCA formulated on Grassmann manifold with the sythetic data received from another network
#
# Reference: 
...
# load graph 
A_metropolis = scio.loadmat("data/A_uniform.mat")["A_uniform"]
...
plt.tight_layout()
plt.grid(True)
plt.savefig("figures/MSD_pca_uniform.pdf", bbox_inches='tight')
plt.show()
